...
workflow {
    ...
    //un_heattree_scripts(run_reporter_haybaler.out.haybaler_heattree_csvs)
...
process test_filenames_same {
    ...
    raspir_name = "raspir/" + name + "*final_stats.csv"
    reporting_csvs = Channel.fromPath('reporting/haybaler/*.csv', checkIfExists: true)

    """
    echo "Filename $reporting_csv"
    echo "Samplename $name"
